...
with DAG(
    dag_id = 'APPL_STOCK_PRICE_TrainPredict',
    ...
    train_input_table = "TRIP_DB.LAB1.STOCK_AAPL"
    train_view = "TRIP_DB.LAB1.STOCK_AAPL_ViEW"
    forecast_table = "TRIP_DB.LAB1.STOCK_AAPL_FORECAST"
    forecast_function_name = "TRIP_DB.LAB1.APPL_STOCK_PRICE_PREDICT"
    final_table = "TRIP_DB.LAB1.AAPL_FINAL"
